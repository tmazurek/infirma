...
router.get('/', (req, res) => {
  CompanyProfile.getProfile((err, profile) => {
    ...
    const zusSettings = {
      zus_base_amount: profile.zus_base_amount,
      ...
      zus_sickness_rate: profile.zus_sickness_rate,
  ...
  CompanyProfile.getProfile((err, profile) => {
    ...
    CompanyProfile.saveProfile(updatedProfile, (err, savedProfile) => {
      ...
      const savedZusSettings = {
        zus_base_amount: savedProfile.zus_base_amount,
        ...
        zus_sickness_rate: savedProfile.zus_sickness_rate,
